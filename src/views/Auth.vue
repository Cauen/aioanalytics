<template>
  <div class="auth">
    <div v-bind:class="{ active: isActive }" class="container">
      <div class="card"></div>
      <div class="card">
        ...
        <form v-on:submit.prevent="Login"> 
          ...
          <div v-on:click="ForgotPassword" class="footer"><a href="#">Forgot your password?</a></div>
        </form>
      </div>
      <div class="card alt">
        <div v-on:click="OpenRegister" class="toggle"><v-icon v-if="!isActive" class="user-icon">create</v-icon></div>
        <h1 class="title">Register
          <div v-on:click="CloseRegiser" class="close"></div>
        </h1>
